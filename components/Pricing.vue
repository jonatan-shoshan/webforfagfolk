    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <div 
          ...
          :key="index" 
          :class="['relative bg-white p-8 rounded-xl shadow-lg', pkg.popular ? 'ring-2 ring-blue-600' : '']"
        >
          ...
          <div class="text-center mb-6">
            ...
            <p class="text-4xl font-bold text-blue-600 mb-2">{{ pkg.price }}</p>
          ...
          <div class="space-y-3 mb-8">
            ...
            >
              <Icon name="lucide:check" class="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
          ...
          <a 
            href="#kontakt"
            :class="[
              'block w-full text-center py-3 px-6 rounded-lg font-semibold transition-colors duration-300',
              pkg.popular 
